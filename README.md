...
bz：每个计划我都会单独地设置一个标题来方便大家获取我的笔记理解,有问题的地方还请大家多多指出

##### 个人目前的逐步学习计划
- 学习C++语言                             (2024.11.17-2024.11.25)
- 学习git的基本用法与扩展        *学习ing*   (2024.11.26-now)
- 学习Cmake的基本知识和用法
- 学习OpenCV
- 学习机器学习(这里推荐西瓜书)

##### 个人的长期学习计划
- 学习编程算法,我会不定期分享自己的算法刷题笔记(我是个半吊子)算法刷题资源推荐:[蓝桥云课](https://www.lanqiao.cn/)，对自己的实力很有自信的推荐[力扣](https://leetcode.cn/)
